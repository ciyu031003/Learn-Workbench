...
const LIGHT_PALETTES: string[][] = [
  ["rgba(255, 243, 218, 0.95)", "rgba(220, 236, 255, 0.88)", "rgba(255, 224, 206, 0.85)", "rgba(214, 243, 230, 0.80)"],
  ["rgba(255, 232, 236, 0.92)", "rgba(226, 232, 255, 0.90)", "rgba(255, 246, 214, 0.85)", "rgba(220, 246, 246, 0.80)"],
  ["rgba(236, 255, 244, 0.90)", "rgba(240, 232, 255, 0.90)", "rgba(255, 238, 220, 0.88)", "rgba(222, 240, 255, 0.82)"],
];
