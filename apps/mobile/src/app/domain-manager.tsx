...
const makeStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    domainSub: { fontSize: typography.caption.fontSize, color: colors.textMuted },
    ...
    tplSub: { fontSize: typography.caption.fontSize, color: colors.textMuted },
    ...
    archivedSub: { fontSize: typography.caption.fontSize, color: colors.textMuted },
    ...
    modalTitle: { fontSize: typography.body.fontSize, fontWeight: "800", color: colors.text },
    input: {
      backgroundColor: colors.surface,
      borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.border,
      paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, color: colors.text,
    },
    colorLabel: { fontSize: typography.caption.fontSize, color: colors.textMuted, fontWeight: "600" },
