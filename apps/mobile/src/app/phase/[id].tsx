...
const makeStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    progressLabel: { fontSize: typography.caption.fontSize, fontWeight: "700", color: colors.textMuted },
    progressValue: { fontSize: 32, fontWeight: "900", color: colors.text },
    progressMeta: { fontSize: typography.caption.fontSize, color: colors.textMuted },
    ...
    addText: { color: colors.primary, fontSize: typography.caption.fontSize, fontWeight: "800" },
    ...
    topicName: { flex: 1, color: "#fff", fontSize: typography.body.fontSize, fontWeight: "800" },
    ...
    topicMeta: { color: "rgba(255,255,255,0.78)", fontSize: typography.caption.fontSize, marginTop: 4 },
