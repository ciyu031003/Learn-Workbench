...
INSERT INTO content_phases (id, phase_key, title, weeks, track, summary, sort_order) VALUES
  (1, 'phase-1', '学习机制 + Agent 启蒙', '第 0-2 周', 'main', '搭建 Anki/笔记/复盘/费曼模板，学习 LLM 基础，完成最小 Agent。', 0),
  (2, 'phase-2', '通信网络进阶', '第 3-8 周', 'main', 'HCIP 理论 + 园区 5G/等保 + eNSP/Wireshark + 网络自动化巡检。', 1),
  (3, 'phase-3', 'ETL 数据仓库开发', '第 9-14 周', 'main', '数仓分层 + SQL 高阶 + Shell/Kettle 调度 + Pandas/DataEase 可视化。', 2),
  (4, 'phase-4', '云 & 虚拟化自动化运维', '第 15-20 周', 'main', 'VDI/KVM/VPC + 天翼云政企 + Shell + Spug/proxmox-utils 批量运维。', 3),
  (5, 'phase-5', '售前解决方案撰写', '第 21-24 周', 'main', '新疆政企投标方案框架 + 需求调研 + 验收流程 + Visio/PPT/Word。', 4),
  (6, 'phase-6', '综合实战 + 证书冲刺', '第 25-30 周', 'main', 'HCIP/ACP 取证 + smart-campus 平台 + ICT 交付助手整合 + 工程化评测。', 5),
  (7, 'phase-7', '面试冲刺 + 新疆求职落地', '第 31-36 周', 'main', '三模块题库 + Agent 专项面试 + 行业知识 + 批量投递。', 6),
